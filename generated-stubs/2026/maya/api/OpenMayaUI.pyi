...
class M3dView:
	...
	def colorMask(self)->list[bool]:
		"""(Deprecated: Please use MHWRender::MUIDrawManager instead.)
	...
	def drawText(self,text:str,position:om.MPoint,textPosition:int=M3dView.kLeft)->Self:
		"""(Deprecated: Please use MHWRender::MUIDrawManager in a MHWRender::MHUDRender operation instead.)
	...
	def readBufferTo2dTexture(self,x:int,y:int,width:int,height:int)->Self:
		"""(Deprecated: Please use MHWRender::MRenderTargetManager instead.)
	...
	def setDrawColor(self,index:int,table:int=M3dView.kActiveColors)->Self:
		"""(Deprecated: Please use MUIDrawManager::setColorIndex instead.)
	...
	def setDrawColorAndAlpha(self,color:om.MColor)->Self:
		"""(Deprecated: Please use MUIDrawManager::setColor instead.)
	...
	def writeColorBuffer(self,image:om.MImage,x:int=0,y:int=0)->Self:
		"""(Deprecated: Please use MHWRender::MQuadRender operation inside MHWRender::MRenderOverride instead.)
